...
data_dir = '/Users/Natsume/Downloads/data_for_all/face_generation'
...
"""
Interesting and useful code: take images from folder and plot them
"""
...
"""
Preprocess the Data: from real images in folder to numpy.array
...
The MNIST images are black and white images with a single color channel
CelebA images have 3 color channels or RGB color
"""
...
- Real input images placeholder with rank 4: (`num_samples`, `image_width`, `image_height`, and `image_channels`).

- Z input placeholder with rank 2: (`num_samples`, `z_dim`)

- Learning rate placeholder with rank 0: (learning_rate)

- Return a tuple (tensor of real input images, tensor of z data, learning_rate)
"""
...
- discriminator model needs an option of `reuse`
	- `tf.variable_scope`: scope_name as "discriminator"

- return (tensor output of generator?|discriminator, tensor logits of generator?|discriminator)
"""
...
- Show Output
- show the current output of the generator during training.
- It will help you determine how well the GANs is training.
"""
...
build and train the GANs.

Use:
- `model_inputs(image_width, image_height, image_channels, z_dim)`
- `model_loss(input_real, input_z, out_channel_dim)`
- `model_opt(d_loss, g_loss, learning_rate, beta1)`
- Use the `show_generator_output` to show `generator` output every 100 batches.
